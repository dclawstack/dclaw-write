...
const ROADMAP: Row[] = [
  ...
  { milestone: "M0", task: "Create Neon DB + run migration", status: "in_progress" },
  { milestone: "M0", task: "Link Vercel + first deploy", status: "todo" },
  ...
  { milestone: "M1", task: "Live end-to-end generation", status: "todo" },
  ...
  { milestone: "M4", task: "TipTap rich editor + inline citation chips", status: "todo" },
  { milestone: "M5", task: "Auth (Clerk)", status: "todo" },
  { milestone: "M5", task: "Progress dashboard from _meta.progress", status: "todo" },
  { milestone: "M5", task: "Production deploy green", status: "todo" },
];
